...
- [x] **Fase 12: Monitoreo y Observabilidad**:
  ...
  - AlertManager sin receiver (alertas solo UI)
  - Verificado: targets up (host-node ×2, cert-manager), HTTPS 302 → /login → 200, cert válido, métricas `node_uname_info` con labels `host=d1`/`host=d2`
  - Detalle en [README-TECH.md#fase-12--monitoreo-y-observabilidad](./README-TECH.md#fase-12--monitoreo-y-observabilidad)
